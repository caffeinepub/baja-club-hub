...
import { Trophy, Calendar, Lock, Users, Info } from 'lucide-react';
  ...
  const navigationCards = [
    {
      to: '/about',
      title: 'About Us',
      description: 'Learn about our BAJA Club, our mission, and what drives us',
      icon: Info,
